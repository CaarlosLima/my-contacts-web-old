...
export default function Home() {
  ...
  return (
    <Container>
      ...
      {contacts.length > 0 && (
        <InputSearchContainer>
          <input value={searchTerm} type="text" placeholder="Search by name" onChange={handleChangeSearchTerm} />
        </InputSearchContainer>
      )}
      ...
      <>
        ...
        {filteredContacts.at(0) && (
        <ListHeader orderBy={orderBy}>
          <header>
            <button
              type="button"
              onClick={() => setOrderBy((prevOrderBy) => (prevOrderBy === 'asc' ? 'desc' : 'asc'))}
            >
              <span>Nome</span>
